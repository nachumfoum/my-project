<?php 
    $pro = mysqli_query($con, "select * from organization where email = '".$_SESSION['user']."'");
                            ...
                            <li class='list-none mb-2'>
                                ...
                                <a href="./" class='text-none font-f text-black'> Dashbroad </a>
                                         ...
                                         <li class='list-none mb-2'>
                                            ...
                                            <a href="manageApplicant.php" class='text-none font-f text-black'> Manage applications</a>
                                        </li>

                                        <li class='list-none mb-2'>
                                            <i class="bi bi-card-text text-danger display-7"></i> 
                                            <a href="managePost.php" class='text-none font-f text-black'> Manage posts</a>
                                        </li> 
